...
export ARCH=arm64
export CROSS_COMPILE=$HOME/Desktop/toolchain-8.2/bin/aarch64-buildroot-linux-gnu-
export CROSS_COMPILE_ARM32=$HOME/Desktop/arm32-toolchain/bin/arm-linux-androideabi-
